...
public partial class CodeEditorControl
{
    ...
    private async Task RunScriptAsync()
    {
        ...
        {
            Code = CodeEditor.Text, Context = new() { Parameters = inputParameters, FileName = inputFileName }
        };
        var result = await _scriptEngineFactory.Current.ExecuteScriptAsync(script);
