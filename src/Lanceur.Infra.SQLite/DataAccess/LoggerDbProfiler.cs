...
namespace Lanceur.Infra.SQLite.DataAccess
{
    ...
    public abstract class LoggerDbProfiler : IDbProfiler
    {
        ...
        protected LoggerDbProfiler(bool doFullLogging)
        {
            DoFullLogging = doFullLogging;
        }
        ...
        public virtual void ExecuteFinish(IDbCommand profiledDbCommand, SqlExecuteType executeType,
                                          DbDataReader reader) { }
