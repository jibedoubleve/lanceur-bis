...
{
    public sealed class SQLiteConnectionScopeTest : ISQLiteConnectionScope
    {
        #region Fields
        ...
        public SQLiteConnectionScopeTest(SQLiteConnection connection)
        {
            _connection = 
                connection 
        ...
        public static implicit operator SQLiteConnection(SQLiteConnectionScopeTest scope) => scope._connection;
