...
/// <summary>
///     Provides bidirectional interaction mechanisms with the user requiring explicit response.
/// </summary>
/// <remarks>
///     This service handles blocking dialogues such as confirmations, yes/no questions,
///     and messages requiring user action before continuing execution.
///     Use <see cref="IUserNotificationService" /> for unidirectional communications
///     that do not require user response.
/// </remarks>
public interface IUserDialogueService
{
    #region Methods
    ...
    /// <summary>
    ///     Asynchronously displays a modal dialogue that prompts the user with a Yes/No question.
    /// </summary>
    /// <param name="content">The message or content to be displayed within the modal dialogue.</param>
    ...
    /// <param name="title">The title of the modal dialogue; defaults to "Question" if not specified.</param>
    /// <returns>
    ...
    /// <returns>
    ///     A task returning a tuple where:
    ...
    ///     Allows customisation of the primary button text and an optional secondary button.
    /// </summary>
