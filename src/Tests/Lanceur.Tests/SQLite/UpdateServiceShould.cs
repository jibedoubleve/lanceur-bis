...
public class UpdateServiceShould : TestBase
{
    ...
    [Theory, InlineData("1.9"), InlineData("1.8"), InlineData("1.7")]
    ...
    [Theory, InlineData("error"), InlineData("2"), InlineData(""), InlineData(null)]
    ...
    [Theory, InlineData("1.0", "1.0"), InlineData("1.1", "1.1"), InlineData("1.1.1", "1.1.1"), InlineData("1.1.1.1", "1.1.1.1")]
    ...
    [Theory, InlineData("1.0"), InlineData("1.1"), InlineData("2.0"), InlineData("2.1"), InlineData("2.1.1")]
    ...
    [Theory, InlineData("1.2"), InlineData("1.2.3"), InlineData("1.2.3.4")]
    ...
    [Theory, InlineData("0.9.9"), InlineData("0.9"), InlineData("0.8"), InlineData("0.7")]
