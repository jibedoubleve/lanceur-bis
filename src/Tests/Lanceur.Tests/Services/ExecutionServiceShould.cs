...
public class ExecutionServiceShould : TestBase
{
    ...
    [InlineData("$w$")]
    [InlineData("$W$")]
    public async Task When_executing_lua_script_Then_file_name_replacement_is_done_after_script_execution(
        string fileName
    )
    {
        // arrange
    ...
    [InlineData("$w$")]
    [InlineData("$W$")]
    public async Task When_executing_lua_script_Then_parameter_replacement_is_done_after_script_execution(
    ...
    public async Task When_using_replacements_for_FileName_Then_correct_values_applied(
        string actual,
        string parameters,
        string expected
    )
