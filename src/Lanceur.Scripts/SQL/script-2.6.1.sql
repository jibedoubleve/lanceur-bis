/*
 * #1293: change the doubloon selection criteria
 * Removed icon & notes. That's whether the icon or the notes are different but 
 "arguments",  "file name", "run as" and "lua scripts" ar the same, this is considered as doubloon
 */
