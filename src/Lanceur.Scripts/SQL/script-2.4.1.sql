/* Fix issue in the doubloon view that exclude results when run_as or working_dir is null
 */
...
from alias a
         inner join (select file_name,
                     ...
                     group by file_name,
                              ...
                              run_as,
                              working_dir
                     having count(*) > 1) t on (a.file_name = t.file_name or (a.file_name = t.file_name) is null)
