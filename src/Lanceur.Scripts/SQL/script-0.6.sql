...
insert into settings (s_key, s_value)
values ('HotKey.Key', '18');
insert into settings (s_key, s_value)
values ('HotKey.ModifierKeys', '3');
insert into settings (s_key, s_value)
values ('Window.Position.Left', '600');
insert into settings (s_key, s_value)
values ('Window.Position.Top', '150');
...
create trigger on_alias_name_update
    after update
    on alias_name
begin
