...
public partial class MainViewModel : ReactiveObject
{
    ...
    )
    {
        ...
        SearchAlias = ReactiveCommand.CreateFromTask<string, AliasResponse>(OnSearchAliasAsync, canSearch, schedulerProvider.MainThreadScheduler);
    ...
    private async Task<AliasResponse> OnSearchAliasAsync(string criterion)
    {
        ...
        return new() { Results = results, KeepAlive = results.Any() };
    }
