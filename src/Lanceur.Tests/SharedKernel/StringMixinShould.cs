...
namespace Lanceur.Tests.SharedKernel
{
    public class StringMixinShould
    {
        ...
        public void ReturnLowerString(string expected, string actual)
        {
            actual.ToLowerString().Should().Be(expected);
        }
        ...
        [InlineData("un")]
        [InlineData("deux")]
        public void ReturnTrueOnTextUsingNullOrEmpty(string value)
        {
        ...
        [InlineData("un")]
        [InlineData("deux")]
        public void ReturnTrueOnTextUsingNullOrWhiteSpace(string value)
        {
