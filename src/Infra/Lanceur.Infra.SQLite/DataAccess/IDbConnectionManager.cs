...
namespace Lanceur.Infra.SQLite.DataAccess
{
    ...
    public interface IDbConnectionManager : IDisposable
    {
        ...
        /// <param name="action">
        /// The function to be executed. It accepts an <see cref="IDbTransaction"/> and returns a result of type <typeparamref name="TReturn"/>.
        /// </param>
        /// <returns>
        ...
        /// <param name="action">
        /// The function to be executed. It accepts an <see cref="IDbTransaction"/> and a context object of type <typeparamref name="TContext"/>,
