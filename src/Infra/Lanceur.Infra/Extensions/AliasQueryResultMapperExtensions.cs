...
public static class AliasQueryResultMapperExtensions
{
    ...
    private static string GetIconForEverythingResult(ResultType itemResultType)
        => itemResultType switch
        {
    ...
    public static AliasQueryResult ToAliasQueryResult(this Bookmark bookmark)
        => new()
        {
    ...
    public static AliasQueryResult ToAliasQueryResult(this EverythingResult everythingResult)
        => new()
        {
